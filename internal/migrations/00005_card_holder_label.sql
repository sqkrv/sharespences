-- holder_label — whose plastic this is
...
-- (An earlier draft also added a kind=base enum value here; the semantics
-- were later corrected — «За все покупки» is an ordinary selectable
