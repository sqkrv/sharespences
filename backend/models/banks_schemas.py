...
class AlfaBankSchemas:
    class Transaction(BaseModel):
        ...
        claim: Optional["AlfaBankSchemas.Claim"]
        logo_url: str | None = Field(validation_alias='logoUrl')
        amount: "AlfaBankSchemas.Amount"
        comment: str | None
        mcc: str
        category: "AlfaBankSchemas.Category"
        direction: Literal["EXPENSE", "INCOME"]
        loyalty: "AlfaBankSchemas.Loyalty"
        status: Literal["SUCCESS", "FAILURE"]
        actions: List["AlfaBankSchemas.Action"]
    ...
    class Action(BaseModel):
        type: str
        label: str
        icon: "AlfaBankSchemas.ActionIcon"
